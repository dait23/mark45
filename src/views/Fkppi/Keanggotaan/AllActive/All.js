...
getExport(){
   ...
   var url =  DevApi + 'export/member/unactivated';
    var that = this;
    ...
    axios({
        ...
        responseType: 'blob', // important
         ...
         link.href = url;
         link.setAttribute('download', 'member_unactivated.xlsx'); //or any other extension
      ...
      <div className="animated fadeIn">
        ...
        <Row>
          ...
          <Row className="mt-4 text-center">
            ...
            <Button className="tombolexcel" onClick={this.toggleLoading} ><i className="fa fa-newspaper-o fa-lg "></i> Download Table</Button>
