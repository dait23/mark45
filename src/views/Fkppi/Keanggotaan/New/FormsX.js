...
class Forms extends Component {
  ...
  this.setState({
     ...
     else if(this.state.gambarDA1 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Foto anggota tidak boleh kosong !", {
        autoClose: 2000
      });
    
    }
     else if(this.state.gambarDA2 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Foto Ktp tidak boleh kosong !", {
        autoClose: 2000
      });
    
    }
    else if(this.state.gambarDH1 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Foto tidak boleh kosong !", {
        autoClose: 2000
      });
    
    }
     else if(this.state.gambarDH2 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
    ...
    else if(this.state.gambarOrtu1 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
    ...
    else if(this.state.gambarOrtu2 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     ...
     else if(this.state.gambarOrtu3 == null){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
   ...
   data.append('register_from', this.state.register_from);
      axios.post(url, data).then((response) => {
       ...
       if (response.status == '200') {
        ...
        toast('Tambah Anggota Berhasil', { type: toast.TYPE.SUCCESS, autoClose: 2000, position: toast.POSITION.TOP_CENTER, }, setTimeout("location.href = '/fkppi/keanggotaan/verify';",2000));
                ...
                <Form onSubmit={this.SubmitVer} className="form-horizontal">
                  ...
                  <FormGroup row style={{background:'#f4f4f4',padding:20}}>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>Alamat sesuai KTP <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="textarea"
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                    <Label htmlFor="text-input">Alamat tempat tinggal</Label>
                      <Input 
                      type="textarea" 
                  ...
                  <FormGroup row style={{padding:20}}>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>ALAMAT 1</Label>
                      <Input 
                      type="textarea"
                  ...
                  <FormGroup row style={{background:'#f4f4f4',padding:20}}>
                    <Col xs="12" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input">N.R.P / N.I.P <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text"
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>STATUS KEMILITERAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderMiliter()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KESATUAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderMiliterUO()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>PANGKAT TERAKHIR <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text"
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                    <Label htmlFor="text-input" >JABATAN TERAKHIR <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>JUMLAH ANAK <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="number" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>HUBUNGAN DENGAN ANGGOTA <span style={{color:'red'}}>*</span></Label>
                      {this.renderDarah()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KETERANGAN</Label>
                      <Input 
                      type="textarea" 
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>DOKUMEN ANGGOTA <span style={{color:'red'}}>*</span></Label>
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>DOKUMEN HUBUNGAN <span style={{color:'red'}}>*</span></Label>
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                    <Label htmlFor="text-input">DOKUMEN ORANGTUA <span style={{color:'red'}}>*</span></Label>
