...
class Forms extends Component {
  ...
  this.setState({
       ...
       toast.info("Nama Depan tidak boleh kosong !", {
        autoClose: 2000
      });
     }
     ...
     toast.info("Nama Belakang tidak boleh kosong !", {
        autoClose: 2000
      });
     ...
     else if(this.state.nik == 0){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("No KTP tidak boleh kosong !", {
        autoClose: 2000
      });
      //console.log('Nama Belakang tidak boleh kosong')
     }
     ...
     toast.info("Tempat lahir tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Tanggal lahir tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Nama Ibu Kandung  tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Jenis Kelamin tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Agama tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Pekerjaaan tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Status Perkawinan tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("provinsi tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Kota tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Kecamatan tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Kelurahan tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Alamat Sesuai Ktp tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Nomer HP tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Nomer NRP tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Status tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Tidak boleh kosong !", {
        autoClose: 2000
      });
   }

    else if(this.state.p_military_ranks == ''){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Pangkat tidak boleh kosong !", {
        autoClose: 2000
      });
   }

   else if(this.state.p_military_position == ''){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Jabatan Terakhir tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("Jumlah anak tidak boleh kosong !", {
        autoClose: 2000
      });
   }

   else if(this.state.p_religions_id == ''){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Agama orang tua tidak boleh kosong !", {
        autoClose: 2000
      });
   }
    else if(this.state.p_kinship_id == ''){
     this.setState({
                        loading: false,
                        //invalid:true
                      });
     toast.info("Hubungan orang tua tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("PD tidak boleh kosong !", {
        autoClose: 2000
      });
   }
     ...
     toast.info("PC tidak boleh kosong !", {
        autoClose: 2000
      });
     ...
     toast.info("Rayon tidak boleh kosong !", {
        autoClose: 2000
      });
   ...
   data.append('mothername', this.state.mothername);
   ...
   data.append('p_military_ranks',  this.state.p_military_ranks);
   data.append('p_military_position', this.state.p_military_position);
   ...
   data.append('g_jabatan_start', '10/31/2018');
   data.append('g_jabatan_end', '10/31/2018');
   ...
   data.append('d_skep_pensiun_back', this.state.gambarDH1Back);
   data.append('d_kta_tnipolri', this.state.gambarDH2);
   data.append('d_kta_tnipolri_back', this.state.gambarDH2Back);
   ...
   data.append('register_from', this.state.register_from);
      axios.post(url, data).then((response) => {
       ...
       if (response.status == '200') {
        ...
        toast('Tambah Anggota Berhasil', { type: toast.TYPE.SUCCESS, autoClose: 2000, position: toast.POSITION.TOP_CENTER, }, setTimeout("location.href = '/keanggotaan/verify';",2000));


       }else{

         this.setState({loading: false});
        toast('Tambah Anggota Gagal', { type: toast.TYPE.ERROR, autoClose: 2000, position: toast.POSITION.TOP_CENTER, });
...
onChangeFileDH1x = (event) => {
  let files = event.target.files || event.dataTransfer.files;
  this.setState({
    gambarDH1Back: files[0]
  });
};
...
onChangeFileDH2x = (event) => {
  let files = event.target.files || event.dataTransfer.files;
  this.setState({
    gambarDH2Back: files[0]
  });
};
...
onChangeFileOrtu1x = (event) => {
  let files = event.target.files || event.dataTransfer.files;
  this.setState({
    gambarOrtu1Back: files[0]
  });
};
...
onChangeFileOrtu2x = (event) => {
  let files = event.target.files || event.dataTransfer.files;
  this.setState({
    gambarOrtu2Back: files[0]
  });
};
                ...
                <Form onSubmit={this.SubmitVer} className="form-horizontal">
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      {this.renderGelar1()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>NAMA DEPAN <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>NAMA BELAKANG <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                      invalid={this.state.invalid}
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>Email Anggota <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                      invalid={this.state.invalid}
                      ...
                      <FormFeedback>Nama belakang harus diisi</FormFeedback>
                      <Label htmlFor="text-input" style={{marginTop:20}}>ALIAS</Label>
                      <Input 
                      type="text" 
                      ...
                      placeholder="Alias" />
                      <Label htmlFor="text-input" style={{marginTop:20}}>GELAR BELAKANG</Label>
                      {this.renderGelar2()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>NO KTP / KARTU PELAJAR <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="number" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>TEMPAT LAHIR <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text"
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>TANGGAL LAHIR <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="date" 
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                    <Label htmlFor="text-input">JENIS KELAMIN <span style={{color:'red'}}>*</span></Label>
                      {this.renderGender()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>AGAMA <span style={{color:'red'}}>*</span></Label>
                      {this.renderAgama()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>PENDIDIKAN TERAKHIR <span style={{color:'red'}}>*</span></Label>
                      {this.renderGelar()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>PEKERJAAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderPekerjaan()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>STATUS PERKAWINAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderKawin()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>NAMA PASANGAN </Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>Nama Gadis Ibu Kandung <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                  ...
                  <hr></hr>
                  <FormGroup row style={{background:'#f4f4f4',padding:20}}>
                    <Col xs="12" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input">PROVINSI <span style={{color:'red'}}>*</span></Label>
                      {this.renderCat()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KOTA/ KABUPATEN <span style={{color:'red'}}>*</span></Label>
                      {this.renderKota()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KECAMATAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderKecamatan()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KELURAHAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderKelurahan()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>Alamat Lengkap <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="textarea"
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                      ...
                      <Label htmlFor="text-input" style={{marginTop:0}}>RT/ RW</Label>
                      <Input 
                      type="text" 
                      ...
                      placeholder="RT/ RW"/>
                      <Label htmlFor="text-input" style={{marginTop:20}}>KODE POS</Label>
                      {this.renderPostcode()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>NO TELEPHONE</Label>
                      <Input 
                      type="number" 
                      value={this.state.h_phone} 
                      name="name"
                      onChange={(e) => this.setState({h_phone: e.target.value})} 
                      placeholder="Nomor Telephone" style={{marginTop:20}}/>
                      <Label htmlFor="text-input" style={{marginTop:20}}>NO HANDPHONE <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                  ...
                  <FormGroup row style={{padding:20}}>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      {this.renderProvOf()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KOTA/ KABUPATEN</Label>
                      {this.renderKotaOf()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KECAMATAN</Label>
                      {this.renderKecamatanOf()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KELURAHAN</Label>
                      {this.renderKelurahanOf()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>Alamat Lengkap</Label>
                      <Input 
                      type="textarea"
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>RT/RW</Label>
                      <Input 
                      type="text" 
                  ...
                  <strong>DATA ORANG TUA / ANGGOTA TNI POLRI / PNS TNI POLRI</strong>
                  <hr></hr>
                  <FormGroup row style={{background:'#f4f4f4',padding:20}}>
                    <Col xs="12" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input">N.R.P / N.I.P Orang Tua <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text"
                      value={this.state.p_nrp} 
                      name="name"
                      onChange={(e) => this.setState({p_nrp: e.target.value})} 
                      placeholder="N.R.P / N.I.P Orang Tua" />
                      <Label htmlFor="text-input" style={{marginTop:20}}>NAMA ORANGTUA <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text"
                      ...
                      <Label htmlFor="text-input" style={{marginTop:20}}>STATUS KEMILITERAN Orang Tua<span style={{color:'red'}}>*</span></Label>
                      {this.renderMiliter()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>KESATUAN Orang Tua<span style={{color:'red'}}>*</span></Label>
                      {this.renderMiliterUO()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>PANGKAT TERAKHIR Orang Tua<span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text"
                      value={this.state.p_military_ranks} 
                      name="name"
                      onChange={(e) => this.setState({p_military_ranks: e.target.value})} 
                      placeholder="Pangkat Terakhir Orang Tua" />
                    </Col>
                    <Col  xs="12" sm="6" md="6" lg="6">
                    <Label htmlFor="text-input" >JABATAN TERAKHIR Orang Tua <span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="text" 
                      value={this.state.p_military_position} 
                      name="name"
                      onChange={(e) => this.setState({p_military_position: e.target.value})} 
                      placeholder="Jabatan Terakhir Orang tua" />
                      <Row>
                      <Col  xs="6" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input" style={{marginTop:20}}>JUMLAH ANAK Orang Tua<span style={{color:'red'}}>*</span></Label>
                      <Input 
                      type="number" 
                      value={this.state.p_childrens} 
                      name="name"
                      onChange={(e) => this.setState({p_childrens: e.target.value})} 
                      placeholder="Jumlah Anak Orang Tua" />
                      </Col>
                      <Col  xs="6" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input" style={{marginTop:20}}>Agama Orang Tua <span style={{color:'red'}}>*</span></Label>
                      {this.renderAgamaOrtu()}
                      </Col>
                      </Row>
                      <Label htmlFor="text-input" style={{marginTop:20}}>Hubungan Anggota dengan Orang Tua <span style={{color:'red'}}>*</span></Label>
                      {this.renderDarah()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>Keterangan Lainnya</Label>
                      <Input 
                      type="textarea" 
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      {this.renderMembers()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>TERDAFTAR ANGGOTA SEJAK TAHUN</Label>
                      <Input 
                      type="number"
                      value={this.state.g_registered_at} 
                      name="g_registered_at"
                      onChange={(e) => this.setState({g_registered_at: e.target.value})} 
                      placeholder="contoh: 2018" />
                      <Label htmlFor="text-input" style={{marginTop:20}}>PD <span style={{color:'red'}}>*</span></Label>
                      {this.renderPD()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>PC <span style={{color:'red'}}>*</span></Label>
                      {this.renderPC()}
                    </Col>
                    <Col  xs="12" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input">RAYON <span style={{color:'red'}}>*</span></Label>
                      {this.renderRayon()}
                      <Label htmlFor="text-input" style={{marginTop:20}}>JABATAN <span style={{color:'red'}}>*</span></Label>
                      {this.renderJabatan()}
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="4" md="4" lg="4">
                      <Label htmlFor="text-input">Foto KTA Depan (KARTU TANDA ANGGOTA) <span style={{color:'red'}}></span></Label>

                      <Input type="file" id="file-input1" name="FileKTA1" onChange={this.onChangeFileKTA1}/>

                       <Label htmlFor="text-input" style={{marginTop:15}}>Foto KTA Belakang (KARTU TANDA ANGGOTA) <span style={{color:'red'}}></span></Label>
                      <Input type="file" id="file-input2" name="FileKTA2" onChange={this.onChangeFileKTA2}/>

                        <Label htmlFor="text-input" style={{marginTop:15}}>Foto Anggota <span style={{color:'red'}}></span></Label>
                        <Input type="file" id="file-input3" name="FileDA1" onChange={this.onChangeFileDA1}/>

                         <Label htmlFor="text-input" style={{marginTop:15}}>KTP / Kartu Pelajar Anggota <span style={{color:'red'}}></span></Label>
                        <Input type="file" id="file-input4" name="FileDA2" onChange={this.onChangeFileDA2}/>
                     
                    </Col>
                    <Col  xs="12" sm="4" md="4" lg="4">
                    <Label htmlFor="text-input">Skep Pensiun Depan <span style={{color:'red'}}></span></Label>
                      <Input type="file" id="file-input5" name="FileDH1" onChange={this.onChangeFileDH1}/>
                     <Label htmlFor="text-input" style={{marginTop:15}}>Skep Pensiun Belakang <span style={{color:'red'}}></span></Label>
                    <Input type="file" id="file-input5" name="FileDH1x" onChange={this.onChangeFileDH1x}/>

                      <Label htmlFor="text-input" style={{marginTop:15}}>KTA TNI / Polri Depan <span style={{color:'red'}}></span></Label>
                   <Input type="file" id="file-input6" name="FileDH2" onChange={this.onChangeFileDH2}/>

                       <Label htmlFor="text-input" style={{marginTop:15}}>KTA TNI / Polri Belakang <span style={{color:'red'}}></span></Label>
                     <Input type="file" id="file-input6" name="FileDH2x" onChange={this.onChangeFileDH2x}/>

                      <Label htmlFor="text-input" style={{marginTop:15}}>Keterangan Lainnya</Label>

                      <Input type="file" id="file-input9" name="FileOrtu1" onChange={this.onChangeFileOrtu1}/>
                      {/* <Input 
                      type="text"
                     ...
                     <Col  xs="12" sm="4" md="4" lg="4">
                      ...
                      <Label htmlFor="text-input" style={{marginTop:0}}>Akte Kelahiran / Ijasah <span style={{color:'red'}}></span></Label>
                      <Input type="file" id="file-input5" name="FileOrtu2" onChange={this.onChangeFileOrtu2}/>

                       <Label htmlFor="text-input" style={{marginTop:20}}>KK / Keterangan Hubungan Darah<span style={{color:'red'}}></span></Label>
                      <Input type="file" id="file-input6" name="FileOrtu3" onChange={this.onChangeFileOrtu3}/>
