...
class Forms extends Component {
  ...
  formats = [
        ...
        .then(function(response) {
          ...
          that.setState({ data : result,
                  ...
                  d_KTA1: result.documents[0].path,
                    ...
                    d_DH2Back: result.documents[10].path,
   ...
   datax.append('d_skep_pensiun_back', this.state.gambarDH1xBack);
   datax.append('d_kta_tnipolri', this.state.gambarDH2x);
   datax.append('d_kta_tnipolri_back', this.state.gambarDH2xBack);
...
onChangeFileDH1Back = (event) => {
  let files = event.target.files || event.dataTransfer.files;
  this.setState({
    gambarDH1xBack: files[0]
  });
};
...
onChangeFileDH2Back = (event) => {
  let files = event.target.files || event.dataTransfer.files;
  this.setState({
    gambarDH2xBack: files[0]
  });
};
                ...
                <Form onSubmit={this.SubmitVer} className="form-horizontal">
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      {this.renderGelar1()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>NAMA DEPAN </Label>
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>NAMA BELAKANG</Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>Email Anggota</Label>
                      <Input 
                      type="email" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>ALIAS</Label>
                      {this.renderAlias()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>GELAR BELAKANG</Label>
                      {this.renderGelar2()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>NO KTP / KARTU PELAJAR</Label>
                      <Input 
                      type="text" 
                      disabled 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>TEMPAT LAHIR </Label>
                      <Input 
                      type="text"
                      disabled 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>TANGGAL LAHIR <strong> {this.state.birthdate}</strong></Label>
                      <Input 
                      type="date"
                      disabled 
                    ...
                    <Label htmlFor="text-input">JENIS KELAMIN</Label>
                      {this.renderGender()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>AGAMA</Label>
                      {this.renderAgama()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>PENDIDIKAN TERAKHIR</Label>
                      {this.renderGelar()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>PEKERJAAN</Label>
                      {this.renderPekerjaan()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>STATUS PERKAWINAN</Label>
                      {this.renderKawin()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>NAMA PASANGAN</Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>NAMA Gadis Ibu Kandung</Label>
                      <Input 
                      type="text" 
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      {this.renderCat()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>KOTA/ KABUPATEN</Label>
                      {this.renderKota()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>KECAMATAN</Label>
                      {this.renderKecamatan()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>KELURAHAN</Label>
                      {this.renderKelurahan()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>Alamat Lengkap</Label>
                      <Input 
                      type="textarea"
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                      ...
                      placeholder="RT/ RW"/>
                      <Label htmlFor="text-input" style={{marginTop:15}}>KODE POS</Label>
                      {this.renderPostcode()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>NO TELEPHONE</Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>NO HANDPHONE</Label>
                      <Input 
                      type="text" 
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input">N.R.P / N.I.P Orang Tua</Label>
                      <Input 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>NAMA ORANGTUA Orang Tua</Label>
                      <Input 
                      type="text"
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>STATUS KEMILITERAN Orang Tua</Label>
                      {this.renderMiliter()}
                      <Label htmlFor="text-input">KESATUAN Orang Tua</Label>
                      {this.renderMiliterUO()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>PANGKAT TERAKHIR Orang Tua</Label>
                      <Input 
                      type="text"
                    ...
                    <Col  xs="12" sm="6" md="6" lg="6">
                    <Label htmlFor="text-input">JABATAN TERAKHIR Orang Tua</Label>
                      <Input 
                      type="text" 
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>JUMLAH ANAK Orang Tua</Label>
                      <Input 
                      type="text" 
                      ...
                      <Col  xs="6" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input" style={{marginTop:15}}>AGAMA Orang Tua</Label>
                      {this.renderAgamaOrtu()}
                      </Col>
                      </Row>
                      <Label htmlFor="text-input" style={{marginTop:15}}>Hubungan Anggota dengan Orang Tua</Label>
                      {this.renderDarah()}
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="6" md="6" lg="6">
                      ...
                      {this.renderMembers()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>TERDAFTAR ANGGOTA SEJAK</Label>
                      <Input 
                      type="number"
                      ...
                      placeholder="Judul Berita" />
                      <Label htmlFor="text-input" style={{marginTop:15}}>PD</Label>
                      {this.renderPD()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>PC</Label>
                      {this.renderPC()}
                    </Col>
                    <Col  xs="12" sm="6" md="6" lg="6">
                      <Label htmlFor="text-input">RAYON</Label>
                      {this.renderRayon()}
                      <Label htmlFor="text-input" style={{marginTop:15}}>JABATAN </Label>
                      {this.renderJabatan()}
                  ...
                  <FormGroup row>
                    <Col xs="12" sm="4" md="4" lg="4">
                      <Label htmlFor="text-input">FOTO KTA DEPAN(KARTU TANDA ANGGOTA</Label>
                      ...
                      <Input type="file" id="file-input1" name="FileKTA1" onChange={this.onChangeFileKTA1}/>
                       <Label htmlFor="text-input" style={{marginTop:15}}>FOTO KTA BELAKANG(KARTU TANDA ANGGOTA</Label>
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>Foto Anggota</Label>
                      ...
                      <Input type="file" id="file-input3" name="FileDA1" onChange={this.onChangeFileDA1}/>
                        <Label htmlFor="text-input" style={{marginTop:15}}>Foto KTP / Kartu Pelajar</Label>
                    ...
                    <Col  xs="12" sm="4" md="4" lg="4">
                    <Label htmlFor="text-input">Akte / Ijasah</Label>
                      ...
                      <Input type="file" id="file-input8" name="FileOrtu2" onChange={this.onChangeFileOrtu2}/>
                       ...
                       <Label htmlFor="text-input" style={{marginTop:15}}>KK / Keterangan Hubungan Darah</Label>
                      ...
                      <Col  xs="12" sm="4" md="4" lg="4">
                      <Label htmlFor="text-input">Skep Pensiun Depan</Label>
                      ...
                      <Label htmlFor="text-input" style={{marginTop:15}}>Skep Pensiun Belakang</Label>
                      <div className="DocEditPhoto text-center"><img src={this.state.d_DH1Back} alt={this.state.d_DH1Back} height="70px"/></div>
                      <Input type="file" id="file-input5" name="FileDH1Back" onChange={this.onChangeFileDH1Back}/>

                      <Label htmlFor="text-input" style={{marginTop:15}}>KTA TNI / POLRI  Depan</Label>
                      ...
                      <Input type="file" id="file-input6" name="FileDH2" onChange={this.onChangeFileDH2}/>
                       ...
                       <Label htmlFor="text-input" style={{marginTop:15}}>KTA TNI / POLRI  Belakang</Label>
                      <div className="DocEditPhoto text-center"><img src={this.state.d_DH2Back} alt={this.state.d_DH2Back} height="70px"/></div>
                      <Input type="file" id="file-input6" name="FileDH2Back" onChange={this.onChangeFileDH2Back}/>
