...
//   }
  ...
  render() {
    ...
    return (
      <tr>
       <td className="text-left">{this.props.news.news_title}</td>
       <td className="text-center">{this.props.news.news_source}</td>
       <td className="text-center">{this.props.news.admin_positition}</td>
       <td className="text-center">{this.props.news.admin_username}</td>
        <td className="text-center">{this.props.news.admin_fullname}</td>
       <td className="text-center">{this.props.news.date}</td>
