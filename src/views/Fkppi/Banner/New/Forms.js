     ...
     var url =  DevApi + 'banner/add';
      ...
      axios.post(url, data).then((response) => {
         ...
         if(response.status == 200) {
          ...
          toast('Berhasil Tambah', { type: toast.TYPE.SUCCESS, autoClose: 3000, position: toast.POSITION.TOP_CENTER, }, setTimeout("location.href = '/banner';",3000));
